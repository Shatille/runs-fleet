...
// that target an externally-defined custom label (e.g. a label like
// "gpu-large" inherited from another runner system) be served by runs-fleet
// without editing the workflow. The Spec is an ordinary runs-fleet label spec
