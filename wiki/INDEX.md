...
Total topics: 19 | Total concepts: 4 | Total sources: ~120 files (with cross-topic overlap)
...
| [cmd-server](topics/cmd-server.md) | orchestrator, Fargate task, server main | 6 | 2026-07-09 | active |
...
| [fleet-orchestration](topics/fleet-orchestration.md) | EC2 Fleet, CreateFleet, spot strategy, launch templates, DefaultFlexibleFamilies, burstable exclusion | 3 | 2026-07-09 | active |
...
| [job-state-machine](topics/job-state-machine.md) | runner manager, registration tokens, lifecycle, JobInfo | 7 | 2026-07-09 | active |
| [state-storage](topics/state-storage.md) | DynamoDB, circuit breaker, SSM/Vault secrets, audit table | 12 | 2026-07-09 | active |
...
| [observability](topics/observability.md) | metrics, CloudWatch, Datadog, Prometheus, slog, cost, tracing, JobStartupSeconds | 19 | 2026-07-09 | active |
| [housekeeping](topics/housekeeping.md) | cleanup tasks, orphan sweep, stale jobs, DLQ redrive | 3 | 2026-04-30 | active |
| [admin-ui](topics/admin-ui.md) | admin API, dashboard, native OIDC auth, audit viewer, cost page, metrics summary | 30 | 2026-07-09 | active |
| [config-bootstrap](topics/config-bootstrap.md) | env vars, RUNS_FLEET_*, AWS clients, timeouts | 3 | 2026-07-09 | active |
...
| [infrastructure](topics/infrastructure.md) | Docker, Packer AMI, pre-baked images, Helm, Nix flake, Makefile | 16 | 2026-07-09 | active |
...
| [two-track-reliability](concepts/two-track-reliability.md) | project-overview, fleet-orchestration, warm-pools, events-and-termination | 2026-07-09 |
...
| [db-record-as-rendezvous](concepts/db-record-as-rendezvous.md) | job-state-machine, state-storage, events-and-termination, observability, internal-services | 2026-07-09 |
