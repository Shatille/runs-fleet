...
variable "runner_sha256" {
  type        = string
  description = "SHA-256 of the linux-x64 actions/runner tarball for runner_version, taken from the release notes. No default, for the same reason as runner_version."
}
